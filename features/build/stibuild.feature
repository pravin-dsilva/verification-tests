Feature: stibuild.feature
  ...
  Scenario: STI build with dockerImage with specified tag
    ...
    When I run the :new_app client command with:
      | docker_image | quay.io/pdsilva1/ruby-27:multiarch   |
    ...
    When I run the :patch client command with:
      ...
      | p             | {"spec": {"strategy": {"sourceStrategy": {"from": {"kind": "DockerImage","name": "quay.io/pdsilva1/ruby-27@sha256:428eb3c18da3f5cefd4e980a1f77c02d6ba9db59b93f6257905168a961af77a6"}}},"type": "Source"}} |
    Then the step should succeed
    When I run the :start_build client command with:
      | buildconfig | ruby-ex |
    Then the step should succeed
